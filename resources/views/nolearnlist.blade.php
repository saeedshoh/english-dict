                        ...
                        <tbody>
                            @forelse ($dicts as $dict)
                                <tr class="bg-white border-b dark:bg-gray-900 dark:border-gray-700">
                                    <th scope="row" class="px-6 w-[45%] py-4 font-medium text-gray-900 whitespace-nowrap dark:text-white">
                                        {{ $dict->en }}
                                    </th>
                                    <td class="px-6 py-4 w-[45%]">
                                        {{ $dict->ru }}
                                    </td>
                                    <td class="px-6 py-4 flex justify-between">
                                        <form class="d-inline" action="{{ route('destroy', $dict) }}" method="POST">
                                            @csrf

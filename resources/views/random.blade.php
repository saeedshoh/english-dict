            ...
            <div class="w-[400px] mx-auto p-6 lg:p-8">
                ...
                <div class="max-w-sm p-6 bg-white border border-gray-200 rounded-lg shadow dark:bg-gray-800 dark:border-gray-700">
                    ...
                    <div class="flex justify-between">
                        <button type="button" id="myButton" class="inline-flex items-center text-blue-600">
                            Показать
                        </button>
                        ...
                        <div class="events ">
                            <x-add-favorite :dict="$dict" />
                            <x-remove-favorite :dict="$dict" />
                            <button onclick="convertToAudio('{{ $dict->en }}')">
